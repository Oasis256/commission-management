              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      ...
                      src="{{ (!empty($editData->profile_photo_path)) ? url('upload/product/'.$editData->profile_photo_path) : url('upload/admin/no-image-box.png') }}" alt="User" name="image" style="width:100px; height:100px;">
                  </div>
                </div>     
