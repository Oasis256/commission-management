          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background:#1f2d3d">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="card-title mt-1 text-light"> <strong>All Product Information</strong> </h3>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="{{ route('product.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square mr-1"></i> Add Product</a>
                    </div>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        src="{{ (!empty($product->product_image)) ? url($product->product_image) : url('upload/admin/no-image-box.png') }}" alt="User" name="image" style="width:70px; height:50px;">
                    </td>
                    ...
                    <td>
                        <a title="edit" href="{{ route('product.edit',$product->id) }}" class="btn btn-sm btn-info"><i class="fas fa-pencil-alt">
                        </i></a>
                         <a title="delete" href="{{ route('product.delete',$product->id) }}" class="btn btn-sm btn-danger" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr> 
                  @endforeach
                  </tbody>
