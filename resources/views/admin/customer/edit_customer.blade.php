...
@section('title', 'Admin Update Customer Information')
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background:#1f2d3d">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="card-title mt-1 text-light"> <strong>Update Customer Information</strong> </h3>
                    </div>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ route('customer.update',$editCustomer->id) }}">
                    @csrf
                    @method('put')
                  <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                      <input type="text" class="form-control" name="name" id="name" value="{{ $editCustomer->name }}">
                      @error('name')
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="phone" class="form-control" name="phone" id="phone" value="{{ $editCustomer->phone }}">
                       @error('phone')
                        <span class="invalid-feedback" style="display:block">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="text" class="form-control" name="email" id="email" value="{{ $editCustomer->email }}">
                       @error('email')
                        <span class="invalid-feedback" style="display:block">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="date" class="form-control" name="date_of_birth" id="date_of_birth" value="{{ $editCustomer->date_of_birth }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="number" class="form-control" name="age" id="age" value="{{ $editCustomer->age }}">
                    </div>
                  </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="text" class="form-control" name="city" id="city" value="{{ $editCustomer->city }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control" name="status">
                        ...
                        <option value="0" {{ $editCustomer->status == 0 ? 'selected':'' }}>In Active</option>
                    </select>
                    @error('status')
                        <span class="invalid-feedback" style="display:block">
                            <strong class="text-danger">{{ $message }}</strong>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <textarea type="text" class="form-control" name="address" id="address" cols="30" rows="3" style="resize: none">{{ $editCustomer->city }}</textarea>
                    </div>
                </div>
