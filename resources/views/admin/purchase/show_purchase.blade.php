                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{ $viewPurchase->product->product_name }}</td>
                          </tr>
                          <tr >
                            <td class="text-right">Reference No</td>
                            <td>{{ $viewPurchase->reference_no }}</td>
                          </tr>
                          <tr >
                            <td class="text-right">Cost Price</td>
                            <td>{{ $viewPurchase->cost }}TK</td>
                          </tr>
                          <tr >
                            <td class="text-right">Quantity</td>
                            <td>{{ $viewPurchase->quantity }}</td>
                          </tr>
                          <tr>
                            <td  class="text-right">Amount</td>
                            <td>{{ $viewPurchase->payable_amount }}TK</td>
                          </tr>
                          <tr >
                            <td class="text-right">Pay</td>
                            <td>{{ $viewPurchase->paid_amount }}TK</td>
                          </tr>
                          <tr >
                            <td class="text-right">Due</td>
                            <td>{{ $viewPurchase->due }}TK</td>
                          </tr>
