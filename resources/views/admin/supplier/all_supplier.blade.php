...
@section('title', 'Admin All Supplier')
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background:#1f2d3d">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="card-title mt-1 text-light"> <strong>All Supplier Information</strong> </h3>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="{{ route('supplier.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square mr-1"></i> Add Supplier</a>
                    </div>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{ route('supplier.edit',$supplier->id) }}" class="btn btn-sm btn-info"><i class="fas fa-pencil-alt">
                        </i> Edit</a>
                         <a href="{{ route('supplier.delete',$supplier->id) }}" class="btn btn-sm btn-danger" id="delete"><i class="fas fa-trash"></i> Delete</a>
                    </td>
                  </tr> 
                  @endforeach
                  </tbody>
