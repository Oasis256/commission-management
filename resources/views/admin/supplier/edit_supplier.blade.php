...
@section('title', 'Admin Update Supplier')
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background:#1f2d3d">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="card-title mt-1 text-light"> <strong>Update Supplier Information</strong> </h3>
                    </div>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ route('supplier.update',$editSupplier->id) }}">
                    @csrf
                    @method('put')
                  <div class="form-group row">
                      <label for="supplier_name" class="col-sm-1 col-form-label">Name  <span class="text-danger">*</span> </label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control" name="supplier_name" id="supplier_name" value="{{ $editSupplier->supplier_name }}">
                      @error('supplier_name')
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="email" id="email" value="{{ $editSupplier->email }}">
                    @error('email')
                        <span class="invalid-feedback" style="display:block">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="mobile" id="mobile" value="{{ $editSupplier->mobile }}">
                    @error('mobile')
                        <span class="invalid-feedback" style="display:block">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="address" id="address" value="{{ $editSupplier->address }}">
                    @error('address')
                        <span class="invalid-feedback" style="display:block">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <input type="text" class="form-control" name="city" id="city" value="{{ $editSupplier->city }}">
                    </div>
                 </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="state" id="state" value="{{ $editSupplier->state }}">
                    </div>
                 </div>
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="status">
                        ...
                        <option value="1" {{ $editSupplier->status == 1 ? 'selected':'' }} >Active</option>
                        <option value="0" {{ $editSupplier->status == 0 ? 'selected':'' }} >In Active</option>
                    </select>
                    @error('status')
                        <span class="invalid-feedback" style="display:block">
                            <strong class="text-danger">{{ $message }}</strong>
