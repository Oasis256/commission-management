          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background:#1f2d3d">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="card-title mt-1 text-light"> <strong>Product Sell Information</strong> </h3>
                    </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      <tbody>
                          <tr>
                              ...
                              <td>{{ \Carbon\Carbon::parse($sellview->today_date)->format('D, d M, Y')  }}</td>
                          </tr>
                          <tr>
                            <td class="text-right">Name</td>
                            <td>{{ $sellview->product->product_name }}</td>
                          </tr>
                          <tr >
                            <td class="text-right">Invoice No</td>
                            <td>{{ $sellview->invoice_no }}</td>
                          </tr>
                          <tr >
                            <td class="text-right">Product Price</td>
                            <td>{{ $sellview->product->product_price }}TK</td>
                          </tr>
                          <tr >
                            <td class="text-right">Quantity</td>
                            <td>{{ $sellview->quantity }}</td>
                          </tr>
                          <tr>
                            <td  class="text-right">Amount</td>
                            <td>{{ $sellview->payable_amount }}TK</td>
                          </tr>
                          <tr >
                            <td class="text-right">Pay</td>
                            <td>{{ $sellview->paid_amount }}TK</td>
                          </tr>
                          <tr >
                            <td class="text-right">Due</td>
                            <td>{{ $sellview->due }}TK</td>
                          </tr>
